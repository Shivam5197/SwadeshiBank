			...
			<div class="col-md-4">
				<div class="card p-5">
					...
					<form>
						...
						<div class="form-group">
							<label for="issueDate">PAN Card*</label> <input type="number"
			...
			<div class="col-md-8">
					...
					<div class="row">
							...
							<form>
								<div class="form-group">
									<label for="Occupation">Occupation*</label> <input type="text"
										class="form-control" id="phone" placeholder="Business">
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<label for="deliveryAddress">Annual Income</label> <input
										...
										max="100000" step="100" id="rangeInput">
						...
						<div class="col-md-6">
							...
							<form>
								...
								<div class="form-group">
									<label>Net Banking Required?</label>
									<div class="form-check">
										<input class="form-check-input" type="radio" name="agreement"
											id="yesOption" value="yes"> <label
											class="form-check-label" for="yesOption"> Yes </label>
									</div>
									<div class="form-check">
										<input class="form-check-input" type="radio" name="agreement"
											id="noOption" value="no"> <label
											class="form-check-label" for="noOption"> No </label>
									</div>
								</div>
								<div class="form-group">
				...
				<div class="card p-3 mb-3">
					...
					<div class="row  ml-3">
						<div class="checkbox-container">
							<input class="form-check-input" type="checkbox"
								id="confirmationCheckbox"> <label
								for="confirmationCheckbox">I confirm that the above
								information is checked and correct as per the customer.</label>
						</div>
					</div>
					<div class=" row ml-3">
						<div class="terms">
							<input class="form-check-input" type="checkbox"
								id="termsCheckbox"> <label for="termsCheckbox">I
					...
					<div class="row">
						...
						<button class="submit-button">Open Account</button>
					</div>
				</div>
			</div>

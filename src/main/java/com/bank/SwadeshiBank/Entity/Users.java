...
public class Users extends BaseEntity{
	...
	/*
	 * @Override public String toString() { return "{\"" +(userId != null ?
	 * "userId\":\"" + userId + "\" " : "") +(userName != null ? ",\"userName\":\""
	 * + userName + "\" " : "") +(password != null ? ",\"password\":\"" + password +
	 * "\" " : "") +(fullname != null ? ",\"fullname\":\"" + fullname + "\" " : "")
	 * +(fatherName != null ? ",\"fatherName\":\"" + fatherName + "\" " : "")
	 * +(motherName != null ? ",\"motherName\":\"" + motherName + "\" " : "")
	 * +(dateOfBirth != null ? ",\"dateOfBirth\":\"" + dateOfBirth + "\" " : "")
	 * +(gender != null ? ",\"gender\":\"" + gender + "\" " : "") +(maritalStatus !=
	 * null ? ",\"maritalStatus\":\"" + maritalStatus + "\" " : "") +(category !=
	 * null ? ",\"category\":\"" + category + "\" " : "") +(occupation != null ?
	 * ",\"occupation\":\"" + occupation + "\" " : "") +(organisation != null ?
	 * ",\"organisation\":\"" + organisation + "\" " : "") +(annualIncome != null ?
	 * ",\"annualIncome\":\"" + annualIncome + "\" " : "") +(nominieFullName != null
	 * ? ",\"nominieFullName\":\"" + nominieFullName + "\" " : "") +(nominieRelation
	 * != null ? ",\"nominieRelation\":\"" + nominieRelation + "\" " : "")
	 * +(nominieAadharNumber != null ? ",\"nominieAadharNumber\":\"" +
	 * nominieAadharNumber + "\" " : "") +(nominiePanNumber != null ?
	 * ",\"nominiePanNumber\":\"" + nominiePanNumber + "\" " : "")
	 * +(nominieMobileNumber != null ? ",\"nominieMobileNumber\":\"" +
	 * nominieMobileNumber + "\" " : "") +(mobileNumber != null ?
	 * ",\"mobileNumber\":\"" + mobileNumber + "\" " : "") +(email != null ?
	 * ",\"email\":\"" + email + "\" " : "") +(address != null ? ",\"address\":\"" +
	 * address + "\" " : "") +(state != null ? ",\"state\":\"" + state + "\" " : "")
	 * +(city != null ? ",\"city\":\"" + city + "\" " : "") +(pinCode != null ?
	 * ",\"pinCode\":\"" + pinCode + "\" " : "") +(aadharNumber != null ?
	 * ",\"aadharNumber\":\"" + aadharNumber + "\" " : "") +(panNumber != null ?
	 * ",\"panNumber\":\"" + panNumber + "\" " : "") +(isActive != false ?
	 * ",\"isActive\":\"" + isActive + "\" " : "") +
	 * (Hibernate.isInitialized(accountsSet) && accountsSet != null ?
	 * ",\"accountsSet\":" + accountsSet :"" ) + (Hibernate.isInitialized(cardSet)
	 * && cardSet != null ? ",\"productSellCategory\":" + cardSet : "") +
	 * (Hibernate.isInitialized(loansSet) && loansSet != null ? ",\"loansSet\":" +
	 * loansSet :"" ) + (Hibernate.isInitialized(transactionsSet) && transactionsSet
	 * != null ? ",\"transactionsSet\":" + transactionsSet : "") + "}\t"; }
	 */
